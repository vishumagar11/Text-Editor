...
{  
	...
	{  
		...
		,new MenuItem("Save As"),new MenuItem("Print"),new MenuItem("Exit")  
	};  
	...
	MenuItem mi4[]={new MenuItem("About Texteditor")};  
		...
		for(int i=0;i<mi2.length;i++) { m2.add(mi2[i]);  
	...
	setVisible(true);  
		...
		{  
			...
			if(arg.equals("New"))  
				{ dispose();  //It cleans and destroys the Jframe window 
